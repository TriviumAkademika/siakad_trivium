                ...
                <div class="flex flex-row px-6 pb-6 space-x-6">
                    ...
                    <div class="flex flex-col w-1/3 space-y-2">
                        ...
                        <div class="flex flex-col">
                            ...
                            <p class="text-justify text-xs text-hitam">Diberitahukan kepada seluruh Lulusan Periode Ijazah
                                April
                            ...
                            <ol class="list-decimal pl-4">
                                <li class="text-justify text-xs text-hitam">
                                    ljazah digital dapat diunduh mulai tanggal 26 April 2025, pukul 13:00 WIB melalui
                                    website
                                    Trivium Akademika.
                                </li>
                                <li class="text-justify text-xs text-hitam">
                                    Pengambilan ijazah cetak dapat dilakukan pada tanggal 5-9 Mei 2025 pukul 09:00- 14:30
                                    WIB di
                                    Gedung Perpustakaan Lantai 1, Gedung Pascasarjana.
                                </li>
                                <li class="text-justify text-xs text-hitam">
                                    Lulusan yang ingin mengambil dokumen ijazah harus terlebih dahulu melakukan booking
                                    jadwal
                            ...
                            <p class="text-justify text-xs text-hitam">
                                ...
                                perhatian seluruh Lulusan periode Yudisium Trivium Akademika Bulan Februari 2025 dan Maret
                                2025.
                        ...
                        <div class="flex flex-col">
                            ...
                            <ol class="list-decimal pl-4">
                                <li class="text-justify text-xs text-hitam">
                                    Pengisian FRS dapat dilakukan mulai tanggal 4 Agustus 2025 pukul 00.00 WIB dan ditutup
                                    pada
                                    tanggal 12 Agustus 2025 pukul 00.00 WIB melalui website Trivium.
                                </li>
                                <li class="text-justify text-xs text-hitam">
                                    Mahasiswa/i yang terlambat melakukan pengisian FRS diwajibkan untuk menghubungi Dosen
                                    Wali
