                ...
                <div class="flex flex-col grow items-end space-y-4">
                    ...
                    <div class="flex justify-between items-center w-full gap-4">
                        <div class="flex items-center gap-4 flex-1">
                            <form method="GET" action="{{ route('waktu.index') }}" id="filterForm"
                                            ...
                                            <div class="space-y-3">
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="senin" class="ml-3 flex items-center">
                                                        ...
                                                        <span
                                                            class="ml-2 text-xs font-medium text-green-800 bg-green-100 px-2 py-0.5 rounded">SEN</span>
                                                    </label>
                                                </div>
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="selasa" class="ml-3 flex items-center">
                                                        ...
                                                        <span
                                                            class="ml-2 text-xs font-medium text-yellow-800 bg-yellow-100 px-2 py-0.5 rounded">SEL</span>
                                                    </label>
                                                </div>
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="rabu" class="ml-3 flex items-center">
                                                        ...
                                                        <span
                                                            class="ml-2 text-xs font-medium text-blue-800 bg-blue-100 px-2 py-0.5 rounded">RAB</span>
                                                    </label>
                                                </div>
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="kamis" class="ml-3 flex items-center">
                                                        ...
                                                        <span
                                                            class="ml-2 text-xs font-medium text-purple-800 bg-purple-100 px-2 py-0.5 rounded">KAM</span>
                                                    </label>
                                                </div>
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="jumat" class="ml-3 flex items-center">
                                                        ...
                                                        <span
                                                            class="ml-2 text-xs font-medium text-red-800 bg-red-100 px-2 py-0.5 rounded">JUM</span>
                                                    </label>
                                                </div>
                                            </div>
                                            <div
                                ...
                                <select name="sort" id="sortSelect" onchange="this.form.submit()"
                                    class="inline-flex items-center px-3 py-2 border border-gray-300 text-gray-700 bg-white rounded-lg text-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                    <option value="hari" {{ request('sort') == 'hari' ? 'selected' : '' }}>Sort by Hari
                                    </option>
                                    <option value="id" {{ request('sort') == 'id' ? 'selected' : '' }}>Sort by ID
                                    </option>
                                    <option value="jam_mulai" {{ request('sort') == 'jam_mulai' ? 'selected' : '' }}>Sort by
                                        Jam Mulai</option>
                                    <option value="jam_selesai" {{ request('sort') == 'jam_selesai' ? 'selected' : '' }}>
                                        Sort by Jam Selesai</option>
                                </select>
                    ...
                    @if (request('hari'))
                        <div class="flex items-center flex-wrap gap-2 w-full">
                            ...
                            @foreach ((array) request('hari') as $day)
                                ...
                                @endphp
                                <span
                                    class="inline-flex items-center px-2.5 py-1 text-xs font-medium rounded-full {{ $dayColors[$day] ?? 'bg-gray-100 text-gray-800' }}">
                                    {{ strtoupper($day) }}
                                    ...
                                    @foreach ($waktu as $index => $room)
                                        <tr>
                                            ...
                                            <x-table.table-td>
                                                ...
                                                @endphp
                                                <span
                                                    class="px-2 py-1 text-xs font-medium rounded-full {{ $dayColors[$room->hari] ?? 'bg-gray-100 text-gray-800' }}">
                                                    {{ strtoupper($room->hari) }}
                                                </span>
                                            </x-table.table-td>
                                            <x-table.table-td
                                                class="text-center">{{ $room->jam_mulai }}</x-table.table-td>
                                            <x-table.table-td
                                                class="text-center">{{ $room->jam_selesai }}</x-table.table-td>
                                            <td class="px-2 py-2 text-sm text-hitam">
                                                <div class="flex justify-center items-center space-x-1">
                                                    ...
                                                    {{-- Button Hapus --}}
                                                    <form action="{{ route('waktu.destroy', $room->id_waktu) }}"
                                                        method="POST"
                                                        onsubmit="return confirm('Apakah Anda yakin ingin menghapus data waktu ini?')"
                                                        class="inline">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
