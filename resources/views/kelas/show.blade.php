                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">Wali Kelas:
                                        {{ $kelas->dosen->nama_dosen ?? 'Belum ditentukan' }}</p>
                                </div>
                            </div>
                                    ...
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="flex gap-4 mt-1">
                                                ...
                                                <span
                                                    class="inline-flex items-center px-2.5 py-0.5 rounded-full text-sm font-medium bg-pink-100 text-pink-800">
                    ...
                    <div class="overflow-x-auto">
                        @if ($mahasiswa->count() > 0)
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        <th
                                            class="px-6 py-3 text-center text-sm font-semibold text-hitam tracking-wider">
                                            #</th>
                                        <th
                                            class="px-6 py-3 text-center text-sm font-semibold text-hitam tracking-wider">
                                            Nama</th>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200" id="mahasiswaTableBody">
                                    @foreach ($mahasiswa as $index => $mhs)
                                        <tr class="mahasiswa-row hover:bg-gray-50"
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-hitam">
                                                {{ $index + 1 }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    <div>
                                                        <div class="text-sm text-hitam">{{ $mhs->nama }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-hitam">
                                                {{ $mhs->nrp }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-hitam">
                                                {{ $mhs->no_hp }}</td>
                        ...
                        @else
                            <div class="text-center py-12">
                                ...
                                <h3 class="text-lg font-medium text-hitam mb-2">Belum ada mahasiswa</h3>
