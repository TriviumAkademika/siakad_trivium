        ...
        <div class="flex flex-col w-full bg-putih">
            ...
            <div class="flex flex-row px-6 pb-6 space-x-6">
                <div class="flex flex-col grow items-end space-y-4">
                    ...
                    {{-- Search, Filter, dan Tombol Tambah Mahasiswa --}}
                                    ...
                                    <div id="filterDropdown"
                                        ...
                                        <div class="p-4">
                                            ...
                                            <div class="space-y-3">
                                                ...
                                                <div class="flex items-center">
                                                    <input type="checkbox" name="status[]" id="lulus" value="LULUS"
                                                        {{ is_array(request('status')) && in_array('LULUS', request('status')) ? 'checked' : '' }}
                                                        class="status-filter w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                                    <label for="lulus" class="ml-3 flex items-center">
                                                        <span class="text-sm font-medium text-gray-900">Lulus</span>
                                                        <span
                                                            class="ml-2 text-xs font-medium text-blue-800 bg-blue-100 px-2 py-0.5 rounded">LULUS</span>
                                                    </label>
                                                </div>
                                                <div class="flex items-center">
                    ...
                    @if (request('status'))
                        <div class="flex items-center flex-wrap gap-2 w-full">
                            ...
                            @endforeach
                            <a href="{{ route('mahasiswa.index', array_diff_key(request()->query(), ['status' => ''])) }}"
                            ...
                            <tbody class="bg-putih divide-y divide-gray-200">
                                @foreach ($mahasiswa as $index => $m)
                                    <tr class="hover:bg-gray-100">
                                        <x-table.table-td>{{ $mahasiswa->firstItem() + $index }}</x-table.table-td>
                                        ...
                                        <td class="px-2 py-2 text-sm text-hitam">
                                            <div class="flex justify-center items-center space-x-1">
                                                {{-- Button Detail --}}
                                                <a href="{{ route('mahasiswa.show', $m->id_mahasiswa) }}"
                    ...
                    @else
                        ...
                        <div class="w-full text-center py-12 bg-white rounded-lg shadow">
                            <i class="ph ph-student text-6xl text-gray-300 mb-4"></i>
                            @if (request('search'))
                                <h3 class="text-lg font-medium text-gray-900 mb-2">Tidak ada hasil pencarian</h3>
                                <p class="text-gray-500 mb-4">
                                    Tidak ditemukan Mahasiswa yang sesuai dengan pencarian "{{ request('search') }}"
                                </p>
                                <a href="{{ route('mahasiswa.index') }}"
                            ...
                            @else
                                ...
                                <p class="text-gray-500 mb-4">Mulai dengan menambahkan mahasiswa pertama Anda</p>
                                @if (auth()->user()->role === 'admin')
                                    <a href="{{ route('mahasiswa.create') }}"
                                        class="inline-flex items-center px-4 py-2 bg-biru-600 text-white text-sm rounded-md hover:bg-biru-700 transition-colors duration-200">
