        ...
        <div class="flex flex-col w-full bg-putih">
            ...
            <div class="flex flex-col px-6 pb-6">
                ...
                <form action="{{ route('mahasiswa.store') }}" method="POST"
                    ...
                    {{-- NRP --}}
                    <div>
                        <x-form.text-number label="NRP" name="nrp" value="{{ old('nrp') }}" min="0" placeholder="Contoh: 5025221234" />
                        @error('nrp')
                            <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    {{-- Semester --}}
                    <div>
                        <x-form.text-number label="Semester" name="semester" value="{{ old('semester') }}" min="1" placeholder="Contoh: 1" />
                        @error('semester')
                            <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
