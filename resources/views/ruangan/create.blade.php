  ...
  <div class="max-w-md mx-auto bg-white p-6 rounded shadow">
    ...
    <form action="{{ route('ruangan.store') }}" method="POST">
      ...
      <div class="mb-4">
        ...
        <input type="text" name="nama_ruangan" class="w-full border border-gray-300 rounded px-3 py-2" required>
      </div>
      <div class="mb-4">
        <label class="block mb-1 text-sm">Nama Gedung</label>
        <input type="text" name="nama_gedung" class="w-full border border-gray-300 rounded px-3 py-2" required>
      </div>
      <div class="mb-4">
        <label class="block mb-1 text-sm">Kode Ruangan</label>
        <input type="text" name="kode_ruangan" class="w-full border border-gray-300 rounded px-3 py-2" required>
      </div>
